...
{
    [Area("Admin")]
    //[Route("[controller]")] //añadido recientemente
    //[ApiController] //añadido recientemente
    public class CatalogueItemController : Controller
    {
        ...
        public CatalogueItemController(ApplicationDbContext db, IWebHostEnvironment hostEnvironment, IGeneratePdf generatePdf /*añadido recientemente*/)
        {
            _db = db;
        ...
        public async Task<IActionResult> GetPDF(int? id)
        {
            ...
            return new ViewAsPdf("ReportProduct", catalogueVM)
            {
