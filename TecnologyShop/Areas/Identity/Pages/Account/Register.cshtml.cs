...
namespace TecnologyShop.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.SalesAgent))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.SalesAgent));
                    }
                    ...
                    if (role == SD.SalesAgent)
                    {
                        await _userManager.AddToRoleAsync(user, SD.SalesAgent);
                    }
                    else
                    {
